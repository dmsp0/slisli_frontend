...
description = getQueryStringValue("mydescription");
          ...
          success: function () {
            ...
            janus.attach({
              ...
              oncleanup: function () {
                ...
                mystream = null;
                $("#videolocal").html('<button id="publish" class="btn btn-primary">화상송출</button>');
...
function registerUsername() {
  if ($("#roomname").length === 0) {
    ...
    //여기가 방 제목 설정하는 부분
    var roomDescription = $("#description").val();
    if (roomDescription === "") {
      $("#mydescription").removeClass().addClass("label label-warning").html("방 제목을 입력해주세요.");
